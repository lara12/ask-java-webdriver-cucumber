...
#Feature: Delete Assignment (by teacher) cucumber
#  Background:
#    Given Login as a techer
#    When Teacher create Assignment
#    And Teacher assign Quiz to Student
#    Then Student should has Quiz as his Assignment
#  Scenario: Delete Assignment (by teacher) cucumber
#    When Teacher delete Assignment
#    Then Student shouldn't has deleted Assignment
...
Feature: Delete Assignment (by teacher) cucumber
  ...
  @3End-To-End-tests @3.12 @ACA-632
  Scenario: Delete Assignment (by teacher) cucumber
